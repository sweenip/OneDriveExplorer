"""
    ...
    ref: https://pythonassets.com/posts/treeview-in-tk-tkinter/#simple-file-explorer

    ref sample.png that showed up in Windows from WSL2
"""
...
class Application(ttk.Frame):
    ...
    def __init__(self, window: tk.Tk | tk.Toplevel) -> None:
        ...
        self.treeview = ttk.Treeview(self, show="tree", columns=("size", "lastmod")) # Sweeni: added columns

        # Sweeni : this is not working
    ...
    def insert_item(self, name: str, path: Path, parent: str = "") -> str:
        ...
        iid = self.treeview.insert(
            ...
            values=("850 bytes", "18:30") # Sweeni: columns
            )
